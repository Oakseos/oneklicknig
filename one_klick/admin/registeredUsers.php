...
<head>
        <meta charset="utf-8" />
        <title>One klick Nigeria - Registered Users </title>
                            ...
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Registered Users Data</li>
                                    </ol>
                                </div>
                            </div>
                                             ...
                                             <tbody>
                                                <?php 
                                                    ...
                                                    if ($db->connect_error) {
                                                        ...
                                                        $checkUser = "SELECT * FROM db_oneklick "; 
