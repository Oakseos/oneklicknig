                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Buy Airtel Data</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Buy Airtel Data</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header ">
                                    <h2>  
                                        <li class="nav-item"><a href="#settings" data-toggle="tab">Buy airtel Data</a></li>
                                    </h2>
                                    <center> 
                                        ...
                                        <div class="active tab-pane" id="settings">
                                            <form action="" method="post" class="form-horizontal">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <input type="text" name="network_name" value="airtel" readonly="" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                     <div class="col-sm-12">
                                                        <select class="custom-select" required="" name="bundle_type">
                                                            <option value="" selected="" disabled="">Select Bundle Type</option>
                                                            <option value="1.5GB-940-000-AIRTEL">1.5GB-940Naria</option>
                                                            <option value="4.5GB-1900-000-AIRTEL">4.5GB-1900Naria</option>
                                                            <option value="6GB-2400-0-AIRTEL">6GB-2400Naria</option>
                                                            <option value="8GB-2800-0-AIRTEL">8GB-2800Naria</option>
                                                            <option value="11GB-3800-0-AIRTEL">11GB-3800Naria</option>
                                                            <option value="15GB-4700-0-AIRTEL">15GB-4700Naria</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <input type="hidden" name="user_id" value=" <?php echo $_SESSION['id']; ?>" />
                                                ...
                                                <div class="form-group row">
                                                     <div class="offset-sm-2 col-sm-10">
                                                        <button type="submit" class="btn btn-danger"><i class="fa fa-arrow-right"></i>   Buy</button>
                                                     </div>
                                                </div>
                                            </form>
                                        </div>
