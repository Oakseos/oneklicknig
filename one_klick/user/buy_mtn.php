...
require('driver/data/mtn_bundleRequest.php');
                                        ...
                                        <div class="active tab-pane" id="settings">
                                            <form action="" class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <input type="text" name="network_name" value="MTN" class="form-control" readonly >
                                               ...
                                               <?php  // echo $message; 
                                                ...
                                                <div class="form-group row">
                                                    <button type="submit" name="buy" class="btn btn-danger  form-control"><i class="fa fa-arrow-right"></i>Buy</button>
                                                </div>
                                            </form>
