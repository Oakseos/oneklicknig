...
require('driver/data/globundleRequest.php');
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Buy GLO Data</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Buy GLO Data</li>
                                    </ol>
                                </div>
                                        ...
                                        <div class="active tab-pane" id="settings">
                                            ...
                                            <form action="" class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <input type="text" name="network_name" value="GLO" class="form-control" readonly >
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12"> 
                                                        <select name="bundle_type" id="" class="custom-select">
                                               ...
                                               <input type="hidden" name="user_id" value="<?php echo $_SESSION['id']; ?> " />
                                                ...
                                                <div class="form-group">
                                                    <input type="number" placeholder="Enter Beneficiary's Number" class="form-control" name="bnum" required />

                                                     <input type="hidden" name="username" value=" <?php echo $_SESSION['username'];  ?> " >
                                                </div>

                                                <div class="form-group row">
                                                    <button type="submit" class="btn btn-danger  form-control" name="buy"><i class="fa fa-arrow-right"></i>Buy</button>
                                                </div>
