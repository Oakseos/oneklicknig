                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Refer and Earn</h4>
...
<div class="row">
                    ...
                    <center>  <h2> ONEKLICK JOIN, REFER & EARN FOR LIFE PLAN</h2> </center>
                    <p style="text-align: justify;" > This plan was designed to reward efforts of our esteem customers for linking other customers to the organization products and services. Here you will earn 25% Registration Commission on each referral, plus 2% additional purchases commission on Airtime, Data bundle, Cable subscription purchased by those people you refer. This income continues as long as transactions continue to take place daily in your team. With ONE time REGISTRATION fee of #1,000, you continue to enjoy all these services.</p>
                    <br>

                    <h4> FAQ</h4>
                    <ol>
                        <li>
                            <h5>HOW DO I JOIN THE PROGRAM? </h5>
                            <p style="text-align: justify;" >  You become a member by registering through our website with a onetime fee of One thousand Naira only (#1,000)</p>  
                        </li>
                        <li><h5>HOW MUCH WILL I EARN AS A MEMBER? </h5>
                            <p style="text-align: justify;" >  Your income is not limited, you earn 25% registration commission on each person you refer to register plus 2% additional commission on recharge on Airtime, Cable subscription, Data Bundle plan purchase by your referral.</p>  </li>
                        <li>
                            <h5>HOW MUCH WILL I EARN AS INDIRECT COMMISSION ON MY TEAM AS A TEAM LEADER?</h5>
                            <p style="text-align: justify;" > As a Team Leader, you earn half of the income of the people you refer both on registration and store purchase on Airtime, Data Bundle, Cable subscription purchased. This continues as long as purchases are made and registration keep coming in and spreading.</p>
                        </li>
                        <li>
                            <h5>HOW AND WHEN DO I GET MY COMMISSION PAID? </h5>
                            <p style="text-align: justify;" > All commissions are paid on weekly bases. This will be credited to your wallet account.</p>
                        </li>
                    </ol>
