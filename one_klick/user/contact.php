                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Contact Admin</h4>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Contact Details</h3>


                <ul class="list-group list-group-unbordered mb-3">

                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right">oneklick20@gmail.com</a>
                  </li>
                  <li class="list-group-item">
                    <b>WhatsApp/Phone Number</b> <a class="float-right"> +2348106089311</a>
                  </li>
                  
                  <li class="list-group-item">
                    <b>Address</b>
                     <a class="float-right">Adejuyigbe Avenue,off Ondo Road, Akure. Ondo State</a>
                  </li>
                </ul>

                <!-- <a href="https://setsub.com/user/editProfile/435" class="btn btn-primary btn-block"><b>Edit Profile</b></a> -->
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
