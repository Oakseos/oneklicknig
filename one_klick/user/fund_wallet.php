...
<head>
    ...
    <link href="assets/css/theme.min.css" rel="stylesheet" type="text/css" />4
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Buy MTN Data</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Buy MTN Data</li>
                                    </ol>
                                </div>
             ...
             <!-- <script src="https://js.paystack.co/v1/inline.js"></script> -->
               <div class="card-body">
                 <div class="form-group">
                   ...
                   <input type="email" name="email" class="form-control" id="	exampleInputEmail1" readonly="" value="
                   <?php 
                  	echo $_SESSION['email'];
                    ?>
                   ">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" name="reference_code" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $_SESSION['ref']; ?>">
                 </div>
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-body">
                    ...
                    <h3>Account Name:  <span><strong> SYLVANUS EMMANUEL TUNDE</strong> </span> </h3>
                    <h3>Account Number:  <span><strong>0034284093 </strong> </span> </h3> 
                    <h3>Bank:  <span><strong>GTB </strong> </span> </h3> 
                </div>
            </div>
