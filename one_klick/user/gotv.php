...
require('driver/cable/gotvRequest.php');
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">GOTV</h4>
                    ...
                    <!-- general form elements -->
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Gotv Subscribtion</h3>
                            </div>
                             <!-- /.card-header -->
                             <!-- form start -->
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" name="dstv" class="form-control" id="exampleInputEmail1" readonly="" value="GOTV">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <select class="custom-select" required="" name="bouquet">
                                                ...
                                                <?php 
                                                          include('driver/database.php'); 
                                                                if ($db->connect_error) {
                                                                    ...
                                                                    $checkBundle = "SELECT * FROM gotv_plan"; 
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" name="ref_key" class="form-control" id="exampleInputEmail1" readonly="" value="setsub019258MW">
