                                ...
                                <div class="col-md-8 col-lg-5">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="" class="p-2" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="password" id="emailaddress" required="" placeholder="Enter Your New Password" name="pass">
                                                </div>

                                                <div class="form-group">
                                                    <label for="emailaddress">Confirm Password</label>
                                                    <input class="form-control" type="password" id="emailaddress" required="" placeholder="Re-type your New Password" name="rpass">
                                                </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12 text-center">
                                            <p class="text-white-50 mb-0">Remember your account? <a href="login.php" class="text-white-50 ml-1"><b>Sign In</b></a></p>
                                        </div>
                                    </div>
