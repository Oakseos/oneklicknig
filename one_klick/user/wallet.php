                        ...
                        <div class="col-xl-6 col-md-6 my-auto">
                            <div class="card card-primary card-outline mt-5">
                                <div class="card-body box-profile">
                                    ...
                                    <?php //print_r($data)  ?>
                                    <p class="text-muted text-center"><?php echo $_SESSION['id']; ?></p>

                                    <ul class="list-group list-group-unbordered mb-5">
                                        <li class="list-group-item">
                                            <b>Name</b>
                                            <a href="" class="float-right"><?php echo $_SESSION['name']; ?></a>
                                        </li>

                                        <li class="list-group-item">
                                            <b>Wallet Balance</b>
                                            <a href="" class="float-right"><?php echo $_SESSION['balance']; ?></a>
                                        </li>

                                         

                                        <a href="fund_wallet.php">
                                            <button class="btn btn-primary btn-block mt-5"> <b>Fund Wallet</b></button>
                                        </a>
